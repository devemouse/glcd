 ...
 *          support for Clock and Power Control firmware
 *          based on IEC60335_ClassB_CM3_library
...
/** @brief Clock source selection multiplexer definition */
...
/** @brief Clock Output Configuration register definition */
...
/** @brief PLL 0 control definition */
...
/** @brief PLL 0 Configuration register definition */
...
/** @brief PLL0 Feed register definition */
/** PLL0 Feed bit mask */
#define CLKPWR_PLL0FEED_BITMASK         ((uint32_t)0xFF)


/** @brief USB PLL control definition */
...
/** @brief USB PLL configuration definition */
...
/** @brief USB PLL status definition */
...
/********************************************************************//**
 * @brief Peripheral Clock Selection Definitions
 **********************************************************************/
...
/********************************************************************//**
** @brief Power Control for Peripherals Definitions
**********************************************************************/
...
/**
 * CLKPWR class provides support for Clock and Power Control firmware.
 */
class CLKPWR {
   public:
      /*****************************************************
       ...
       * @return none
       **********************************************************************/
      static void SetPCLKDiv (uint32_t ClkType, uint32_t DivVal);
       ...
       **********************************************************************/
      static uint32_t GetPCLKSEL (uint32_t ClkType);
       ...
       **********************************************************************/
      static uint32_t GetPCLK (uint32_t ClkType);
       ...
       * @return none
       **********************************************************************/
      static void ConfigPPWR (uint32_t PPType, FunctionalState NewState);
