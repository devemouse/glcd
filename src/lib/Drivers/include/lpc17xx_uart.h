...
#define UART1_RS485CTRL_NMM_DIS		((uint32_t)(1<<0))	/*!< RS-485/EIA-485 Normal Multi-drop Mode (NMM)
														is disabled */
...
#endif
{
	FunctionalState NormalMultiDropMode_State 	:1; /*!< Normal MultiDrop mode State:
													- ENABLE: Enable this function.
													- DISABLE: Disable this function. */
	FunctionalState Rx_State					:1;	/*!< Receiver State:
													- ENABLE: Enable Receiver.
													- DISABLE: Disable Receiver. */
	FunctionalState AutoAddrDetect_State		:1;	/*!< Auto Address Detect mode state:
											- ENABLE: ENABLE this function.
											- DISABLE: Disable this function. */
	FunctionalState AutoDirCtrl_State			:1;	/*!< Auto Direction Control State:
											- ENABLE: Enable this function.
											- DISABLE: Disable this function. */
	uint32_t DirCtrlSel_Pin				:1;	/*<! If direction control is enabled, state:
											- UART1_RS485_CFG_DIRCTRLSEL_RTS:
											pin RTS is used for direction control.
											- UART1_RS485_CFG_DIRCTRLSEL_DTR:
											pin DTR is used for direction control. */

	 SetState DirCtrlPol_Level			:1;	/*!< Polarity of the direction control signal on
											the RTS (or DTR) pin:
	...
	uint32_t MatchAddrValue				:8;	/*!< address match value for RS-485/EIA-485 mode, 8-bit long */
	uint32_t DelayValue					:8;	/*!< delay time is in periods of the baud clock, 8-bit long */
 ...
 */
#define UART_BLOCKING_TIMEOUT			(0x0000FFFFUL)
