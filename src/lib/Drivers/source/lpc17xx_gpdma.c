...
const uint8_t GPDMA_LUTPerBurst[] = {
		GPDMA_BSIZE_1,				// SSP0 Tx
		GPDMA_BSIZE_1,				// SSP0 Rx
		GPDMA_BSIZE_1,				// SSP1 Tx
		GPDMA_BSIZE_1,				// SSP1 Rx
		GPDMA_BSIZE_4,				// ADC
...
const uint8_t GPDMA_LUTPerWid[] = {
		GPDMA_WIDTH_WORD,				// SSP0 Tx
		GPDMA_WIDTH_WORD,				// SSP0 Rx
		GPDMA_WIDTH_WORD,				// SSP1 Tx
		GPDMA_WIDTH_WORD,				// SSP1 Rx
...
/** @defgroup 	GPDMA_Private_Functions
 * @{
 */
...
Status GPDMA_Setup(GPDMA_Channel_CFG_Type *GPDMAChannelConfig, fnGPDMACbs_Type *pfnGPDMACbs)
{
	...
	case GPDMA_TRANSFERTYPE_M2P:
		...
		pDMAch->DMACCDestAddr = GPDMA_LUTPerAddr[GPDMAChannelConfig->DstConn];
		pDMAch->DMACCControl
	...
	case GPDMA_TRANSFERTYPE_P2M:
		...
		pDMAch->DMACCSrcAddr = GPDMA_LUTPerAddr[GPDMAChannelConfig->SrcConn];
