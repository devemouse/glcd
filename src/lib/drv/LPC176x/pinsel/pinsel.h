...
class PINSEL {
   public:
      ...
      typedef enum {
         ...
         P0_29_GPIO         = (0 << 26),
         P0_29_USB_D_PLUS   = (1 << 26),

         P0_30_GPIO         = (0 << 28),
         P0_30_USB_D_MINUS  = (1 << 28),
         ...
         P1_10_GPIO         = (0 << 20),
         P1_10_ENET_RXD1    = (1 << 20),

         P1_14_GPIO         = (0 << 28),
         P1_14_ENET_RX_ER   = (1 << 28),

         P1_15_GPIO         = (0 << 30),
         P1_15_ENET_REF_CLK = (1 << 30),
       ...
       * @return      None
       **********************************************************************/
      static void SetPinFunc ( PortPin_e pinnum, PinFunction_e funcnum);
       ...
       * @return      None
       **********************************************************************/
      static void SetResistorMode (  PortPin_e pinnum, PinMode_e modenum);
       ...
       * @return      None
       **********************************************************************/
      static void SetOpenDrainMode(  PortPin_e pinnum, PinOpenDrain_e modenum);
       ...
       * @return      None
       **********************************************************************/
      static void SetI2C0Pins(I2C_Mode_e i2cPinMode, FunctionalState filterSlewRateEnable);
