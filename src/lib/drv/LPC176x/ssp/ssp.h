...
#define SSP0_PINSEL_SCK_P0_15 {PORT_0, PIN_15, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP0_PINSEL_SSEL_P0_16   {PORT_0, PIN_16, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP0_PINSEL_MISO_P0_17   {PORT_0, PIN_17, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP0_PINSEL_MOSI_P0_18   {PORT_0, PIN_18, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}


   /** SSP0 function pin selection group 1 */
#define SSP0_PINSEL_SCK_P1_20 {PORT_1, PIN_20, PINSEL::FUNC_3, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP0_PINSEL_SSEL_P1_21   {PORT_1, PIN_21, PINSEL::FUNC_3, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP0_PINSEL_MISO_P1_23   {PORT_1, PIN_23, PINSEL::FUNC_3, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP0_PINSEL_MOSI_P1_24   {PORT_1, PIN_24, PINSEL::FUNC_3, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}


/** SSP1 function pin selection group 0 */
#define SSP1_PINSEL_SCK_P0_7  {PORT_0, PIN_7, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP1_PINSEL_SSEL_P0_6 {PORT_0, PIN_6, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP1_PINSEL_MISO_P0_8 {PORT_0, PIN_8, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}

#define SSP1_PINSEL_MOSI_P0_9 {PORT_0, PIN_9, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}


   /** SSP1 function pin selection group 1 */
#define SSP1_PINSEL_SCK_P1_31 {PORT_1, PIN_31, PINSEL::FUNC_2, \
   PINSEL::PINMODE_PULLUP, \
   PINSEL::PINMODE_NORMAL}
...
class SSP {
   public:
       ...
       *****************************************************/
      /**
       * @brief Initializes the SSP peripheral with defualt parameters.
       */
      SSP(LPC_SSP_TypeDef *_SSPx, SSP_CFG_Type *SSP_ConfigStruct);
      ...
      static void ConfigStructInit(SSP_CFG_Type *SSP_InitStruct);
      void Cmd( FunctionalState NewState);
      void LoopBackCmd( FunctionalState NewState);
      void SlaveOutputCmd( FunctionalState NewState);
      void SendData( uint16_t Data);
      uint16_t ReceiveData();
      FlagStatus GetStatus( uint32_t FlagType);
      void IntConfig( uint32_t IntType, FunctionalState NewState);
      IntStatus GetRawIntStatus( uint32_t RawIntType);
      IntStatus GetIntStatus ( uint32_t IntType);
      void ClearIntPending( uint32_t IntType);
      void DMACmd( uint32_t DMAMode, FunctionalState NewState);
