...
{
    // SCK pin
    PINSEL::SetPinFunc (PINSEL_P0_15, SPI_PINFUNC_SCK_P0_15);
    PINSEL::SetResistorMode (PINSEL_P0_15, PINSEL_PINMODE_PULLUP);


    // SSEL pin
    if (spiMode == SPI_SLAVE_MODE)
    {
       PINSEL::SetPinFunc (PINSEL_P0_16, SPI_PINFUNC_SSEL_P0_16);
       PINSEL::SetResistorMode (PINSEL_P0_16, PINSEL_PINMODE_PULLUP);
    }
    else
    {
       // Release SSEL pin as default function
       PINSEL::SetPinFunc (PINSEL_P0_16, PINSEL_FUNC_0);
       PINSEL::SetResistorMode (PINSEL_P0_16, PINSEL_PINMODE_PULLUP);
    }

    // MISO pin
    PINSEL::SetPinFunc (PINSEL_P0_17, SPI_PINFUNC_MISO_P0_17);
    PINSEL::SetResistorMode (PINSEL_P0_17, PINSEL_PINMODE_PULLUP);

    // MOSI pin
    PINSEL::SetPinFunc (PINSEL_P0_18, SPI_PINFUNC_MOSI_P0_18);
    PINSEL::SetResistorMode (PINSEL_P0_18, PINSEL_PINMODE_PULLUP);
}
